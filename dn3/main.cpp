...
void preveri(const string &naloga, vector<long long> maxTrajanjaMS)
{
    ...
    for (const auto &verjetnosti : podatki)
    {
        ...
        auto odgovor = Resitev::izracunajVerjetnosti(verjetnosti, naloga);
...
vector<long long> izracunajMaxT()
{
    ...
    casi[0] = 1000; // kratke
    casi[1] = 15389;//enoStopanje(87000); // --> casi[1] = 20000; // enoStopanje(87000) 
    casi[2] = 35838;//enoStopanje(130000);
    return casi;
}
